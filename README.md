...
A: I first build a list named *diagonal_units*, which represent all boxex in diagonal. Then I add diagonal constraint in *naked twins* *eliminate* and *only_choice*. So, I solved this problem
